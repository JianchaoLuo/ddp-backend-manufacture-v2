...
///**
// * @Author: bobo
// * @Description: 对于决策树节点的测试
// * @DateTime: 2025/3/21 17:14
// **/
...
////    //测试创建决策树节点
////    @Test
////    void newDecisionTreeNodeTest(){
////        // 创建主体判断节点，判断子母车关系
////        DecisionTreeNode<CarNameEnum, SubCarStatusEnum> testNode1 = new DecisionTreeNode<>(
////                OUT_BOUND_SUB_CAR, SubCarStatusEnum.class, null
////        );
//////        System.out.println(testNode1);
//////        System.out.println(testNode1.getKeyResource(predictInfo));
////
////        // 创建地点决策节点,由坐标决定地点
////        Map<Coordinate, Object> coordinateToLocation = new HashMap<>();
////        coordinateToLocation.put(new Coordinate(1, 1), HOT_CLOSING_BOX_WORKSTATION_1);
////        coordinateToLocation.put(new Coordinate(1, 0),HOT_CLOSING_BOX_WORKSTATION_1);
////        coordinateToLocation.put(new Coordinate(2, 1), HOT_CLOSING_BOX_WORKSTATION_2);
////        coordinateToLocation.put(new Coordinate(2, 0), HOT_CLOSING_BOX_WORKSTATION_2);
////        DecisionTreeNode<CarNameEnum, Coordinate> testNode2 = new DecisionTreeNode<>(
////                OUT_BOUND_SUB_CAR, coordinateToLocation, Coordinate.class, null
////        );
//////        System.out.println(testNode2);
//////        System.out.println(testNode2.getKeyResource(predictInfo));
////
////        // 创建地点判断节点
////        DecisionTreeNode<WorkstationNameEnum, WorkstationStatusEnum> testNode4 = new DecisionTreeNode<>(
////                WorkstationStatusEnum.class,
////                ClosingBoxEventName.SUB_CAR_FULL_GO_HOT_SAND_CLOSING_BOX_WORK_POSITION
////        );
////        testNode4.getDecisionResult().setLocationEnum(HOT_CLOSING_BOX_WORKSTATION_2);
//////        System.out.println(testNode4);
//////        System.out.println(testNode4.getKeyResource(predictInfo));
////
////        // 添加子节点
////        testNode2.addChild(new Coordinate(2, 1), testNode4);
////        testNode2.addChild(new Coordinate(2, 0), testNode4);
////        System.out.println(testNode2);
////    }
//}
//
