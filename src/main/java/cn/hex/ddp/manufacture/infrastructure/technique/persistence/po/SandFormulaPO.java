...
@Table(schema = "ddp_manufacture_service_v2", value = "sand_formula", comment = "砂配方")
public class SandFormulaPO extends BaseDatabasePO {

    /**
     * 砂配方型号
     */
    @ColumnComment(value = "砂配方型号")
