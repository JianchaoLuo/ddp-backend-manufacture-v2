...
import cn.hex.ddp.manufacture.infrastructure.algorithm_2.util.event.NodeLinkEvent;
import lombok.Data;
 ...
 * @ClassDescription:
 * @Author: KangHong
 * @Created: 2024/12/8 15:29
 */
@Data
public class NodeAttributeTool {
    /**
     * 当前选择的事件
     */
    private NodeLinkEvent selectEvent;
    /**
     * 仿真总时间
     */
