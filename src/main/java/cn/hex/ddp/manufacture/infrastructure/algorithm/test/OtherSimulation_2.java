 ...
 * @ClassDescription:
 * @Author: KangHong
 * @Created: 2024/12/27 16:14
 */
@Data
@Slf4j
public class OtherSimulation_2 {
    ...
    public OtherSimulationLink
    otherSimulationRun(OutBoundGanttChartLinkInput input, MoldClosingGanttChartLinkInput moldInput, MouldingGanttChartLinkInput mouldingInput,
...
//                            log.info("???" + " " + mouldingInput.getInput().getHotSandBoxOpeningPosition_2().getProduct());
        ...
        OutBoundGanttChartLinkInput outboundGanttChartLinkInput;
        outboundGanttChartLinkInput = input;
        MoldClosingGanttChartLinkInput moldClosingGanttChartLinkInput;
    ...
    public static void createHotMouldEvent(OutBoundGanttChartLinkInput outBoundInput, MouldingGanttChartLinkInput mouldingInput,
        ...
        event = allTools.createEvent("001018", "moke", 0.0, 0.0, 0.0,
                ...
                null, null, false, null, null,
                false, null, null, null, null,
                mouldingInput.getInput().getHotSandBoxOpeningPosition_2().getId(), startPositionStatus, startPositionStatus, null, null,
        ...
        event = allTools.createEvent("001021", "moke", 0.0, 0.0, 0.0,
                ...
                null, false, null,
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_1().getId(), startEquipmentStatus, endEquipmentStatus,
                null, null, null, null, null,
                null, null, null, null, mouldingInput.getInput().getHotSpray_1().getId(),
                ExecuteTypeEnum.EQUIPMENT, InstructionsEnum.NOTICE, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001059", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), startSubCarStatus, false, null,
                endSubCarStatus, false, null,
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_1().getId(), endEquipmentStatus, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, InstructionsEnum.RISING, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001060", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), endSubCarStatus, false, null,
                endSubCarStatus, true, mouldingInput.getInput().getHotSpray_2().getEquipmentCoordinate(),
                null, null, false, null, null,
                false, null, null, null, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, RUNNING, mouldingInput.getInput().getHotSpray_2().getEquipmentCoordinate(), null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("002061", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), endSubCarStatus, false, null,
                startSubCarStatus, true, mouldingInput.getInput().getHotSpray_2().getEquipmentCoordinate(),
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_2().getId(), null, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, LANDING, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001062", "moke", 0.0, 0.0, 0.0,
                null, null, false, null,
                null, false, null,
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_2().getId(), startEquipmentStatus, endEquipmentStatus,
                null, null, null, null, null,
                null, null, null, null, mouldingInput.getInput().getHotSpray_2().getId(),
                ExecuteTypeEnum.EQUIPMENT, InstructionsEnum.NOTICE, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001063", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), startSubCarStatus, false, null,
                endSubCarStatus, false, null,
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_2().getId(), endEquipmentStatus, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, InstructionsEnum.RISING, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001064", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), endSubCarStatus, false, null,
                endSubCarStatus, true, mouldingInput.getInput().getHotSpray_3().getEquipmentCoordinate(),
                null, null, false, null, null,
                false, null, null, null, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, RUNNING, mouldingInput.getInput().getHotSpray_3().getEquipmentCoordinate(), null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("002065", "moke", 0.0, 0.0, 0.0,
                input.getHotUpSpray().getId(), endSubCarStatus, false, null,
                startSubCarStatus, true, mouldingInput.getInput().getHotSpray_3().getEquipmentCoordinate(),
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_3().getId(), null, null,
                null, null, null, null, null,
                null, null, null, null, input.getHotUpSpray().getId(),
                SUB_CAR, LANDING, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);

        event = allTools.createEvent("001066", "moke", 0.0, 0.0, 0.0,
                null, null, false, null,
                null, false, null,
                null, null, false, null, null,
                false, null, mouldingInput.getInput().getHotSpray_3().getId(), startEquipmentStatus, endEquipmentStatus,
                null, null, null, null, null,
                null, null, null, null, mouldingInput.getInput().getHotSpray_3().getId(),
                ExecuteTypeEnum.EQUIPMENT, InstructionsEnum.NOTICE, null, null);
        mouldingInput.getGanttChart().getEventLinkGantts().get(mouldingInput.getInput().getMouldingIndexInput().getHotUpMokeInputInGanttIndex()).getEvents().add(event);
